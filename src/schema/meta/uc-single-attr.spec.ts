...
import { UcSingleAttr } from './uc-single-attr.js';

describe('UcSingleAttr', () => {
  let meta: UcMeta;
  let attr: UcMetaAttr<number>;

  beforeEach(() => {
    meta = new UcMeta();
    attr = new UcSingleAttr<number>('test');
  });

  it('is identified by uid', () => {
    const attr1 = new UcSingleAttr('attr1');
    const attr2 = new UcSingleAttr('attr2', attr1);
    const attr3 = new UcSingleAttr('attr3', 'attr3');
